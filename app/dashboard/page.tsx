    ...
    <div className="h-screen w-full bg-gray-200 p-3 flex flex-col overflow-hidden font-sans">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center mb-3 h-auto shrink-0 px-2 gap-3 lg:gap-0">
        ...
        <div className="flex flex-wrap lg:flex-nowrap items-center justify-center gap-2 lg:gap-4 w-full lg:w-auto">
          ...
          {/* Botón de Imprimir/Exportar a PDF Nativo */}
          <button 
            onClick={() => window.print()}
            className="bg-blue-600 hidden md:flex hover:bg-blue-700 text-white p-3 rounded-xl transition-colors shadow-md justify-center items-center print:hidden"
          ...
          <button 
            ...
            className="bg-slate-800 hidden md:inline hover:bg-slate-700 text-white p-3 rounded-xl transition-colors shadow-md print:hidden"
